...
enum cinit_svc_status {
   /* first define basics */
   CINIT_ST_SH_ONCE     = 0x1,     /* service SHould be started once           x*/
   CINIT_ST_SH_RESPAWN  = 0x2,     /* service SHould respawn                   x*/
   ...
   CINIT_ST_ONCE_RUN    = 0x100,   /* the once process is currently running    x*/
